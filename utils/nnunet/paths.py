...
nnUNet_raw = '/mnt/data1/yujunxuan/MICCAI_challenge_method/nnUNet-master/nnunetv2/Dataset/nnUNet_raw'
nnUNet_preprocessed = '/mnt/data1/yujunxuan/MICCAI_challenge_method/yolov5-SAM-Med3D/config'
