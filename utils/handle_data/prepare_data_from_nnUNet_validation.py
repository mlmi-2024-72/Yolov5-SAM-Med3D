...
if __name__ == "__main__":
    ...
    target_dir = "./data/validation/Dataset130_MICCAI_challenge"
    ...
    for dataset in dataset_list:
        ...
        total_files += len(os.listdir(osp.join(dataset_dir, "imagesTs")))  # assuming imagesTr contains the images
    ...
    for dataset in dataset_list:
        ...
        with ThreadPoolExecutor(max_workers=max_threads) as executor:
            ...
            for cls_name, idx  in meta_info["labels"].items():
                ...
                images_dir = osp.join(dataset_dir, "imagesTs")
                labels_dir = osp.join(dataset_dir, "labelsTs")
