...
import Stage1.val as validate  # for end-of-epoch mAP
...
def train(hyp, opt, device, callbacks):
    ...
    if pretrained:
        ...
        # print(weights)
        # weights = weights.replace('last','best')
...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "ckpt/yolov5m-seg.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=ROOT / "config/models/segment/yolov5m-seg.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "config/MICCAI_data_seg.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "config/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    ...
    parser.add_argument("--noplots", action="store_true",default=False, help="save no plot files")
    ...
    parser.add_argument("--mask-ratio", type=int, default=2, help="Downsample the truth masks to saving memory")
    parser.add_argument("--no-overlap", action="store_true", default=True, help="Overlap masks train faster at slightly less mAP")
