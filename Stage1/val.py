...
def parse_opt():
    ...
    # parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train-seg/exp3/weights/best.pt", help="model path(s)")
    parser.add_argument("--weights", nargs="+", type=str, default="/mnt/data1/yujunxuan/MICCAI_challenge_method/YOLOV5/runs/train-seg/exp3/weights/best.pt", help="model path(s)")
    ...
    parser.add_argument("--project", default=ROOT / "runs/test-seg", help="save results to project/name")
