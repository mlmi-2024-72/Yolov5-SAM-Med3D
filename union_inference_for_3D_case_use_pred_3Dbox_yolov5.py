...
click_methods = {
    ...
    'ritm': get_next_click3D_torch_with_pred_3Dbox,
...
def run_inference(args):
    ...
    for batch_data in tqdm(test_dataloader):
        ...
        if(args.skip_existing_pred and osp.exists(pred_path)):
            ...
            sliding_window_list = pad_and_crop_with_sliding_window_with_box_in(image3D_full, pred_3D_boxes, crop_transform)
            if len (sliding_window_list) == 0:
                sliding_window_list = pad_and_crop_with_sliding_window_with_box_overlab(image3D_full, pred_3D_boxes, crop_transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='./results/union_out_dice_use_yolov5_step_0_5.py')
