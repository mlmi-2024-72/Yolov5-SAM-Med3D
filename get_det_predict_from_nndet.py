...
def pad_and_crop_with_sliding_window(img3D, boxes_3D, crop_transform, tile_step_size=0.2):
    subject = tio.Subject(
...
def run_inference(args):
    ...
    for batch_data in tqdm(test_dataloader):
        ...
        if(args.skip_existing_pred and osp.exists(pred_path)):
            ...
            sliding_window_list = pad_and_crop_with_sliding_window(image3D_full, gt_3Dbox, crop_transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task_name', type=str, default='MICCAI_Challenge_2024_use_gt_3Dbox_step_0_2')
    parser.add_argument('--save_name', type=str, default='union_out_dice_use_gt_3Dbox_step_0_2.py')
